...
pub async fn upload(client: &Client, endpoint: &str, image_data: Vec<u8>, filename: &str, bucket: &str) -> Result<String, String> {
...
pub async fn get_client_and_endpoint() -> Client {
